...
Creating a worktree naturally creates a feature branch, which satisfies the `protected_branch` requirement. This means you can start editing immediately after worktree setup.
