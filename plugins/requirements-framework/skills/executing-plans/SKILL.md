...
4. Use `requirements-framework:test-driven-development` for any new code
5. Mark as completed
...
- Run `/pre-commit` to review changes before committing
...
- **REQUIRED SUB-SKILL:** Use `requirements-framework:finishing-a-development-branch`
